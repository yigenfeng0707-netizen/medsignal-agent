...
| [用户使用手册](docs/用户使用手册.md) | 7 大功能操作指南 + 脑电评估 + 常见问题 | 终端用户 |
| [升级完成报告](docs/升级完成报告.md) | v2.1.0 完整升级记录 + EEG 集成成果 + 验收结果 | 评委 / 评审 |
| [API 接口文档](docs/api_contract.md) | 27 个 API 接口契约 | 开发者 |
| [路演脚本](docs/roadshow_script.md) | 10 分钟路演流程与话术 | 演讲者 |
